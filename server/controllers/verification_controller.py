...
import os
from utils.helpers import normalize_path, ensure_utc
...
async def generate_otp(candidate_id: str, db: Session):
    try:
        ...
        email_payload = CandidateInOtp(
            ...
            store_state=candidate.store.state,
...
async def facial_recognition(img_path: str, store_id: str):
    try:
        ...
        return norm_found_cand_img_path
...
async def upload_laptop_issuance(
    candidate_id: str, db: Session, photo_url: str, laptop_serial: str
):
    try:
